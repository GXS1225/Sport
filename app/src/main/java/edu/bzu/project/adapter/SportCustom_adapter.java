...
import edu.bzu.project.adapter.SportsData_adapter.ViewEntity;
...
public class SportCustom_adapter extends BaseAdapter{
	...
	public SportCustom_adapter(Context context,List<Sport_w> list) {
		super();
