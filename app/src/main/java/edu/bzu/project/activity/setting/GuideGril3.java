...
public class GuideGril3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.guide_gril3);
		...
		Animation animation0 = AnimationUtils.loadAnimation(
				GuideGril3.this, R.anim.tutorail_scalate_top);
		...
		Animation animation1 = AnimationUtils.loadAnimation(
				GuideGril3.this, R.anim.tutorail_bottom);
		...
		Animation animation2 = AnimationUtils.loadAnimation(
				GuideGril3.this, R.anim.tutorail_lr);
		...
		Animation animation3 = AnimationUtils.loadAnimation(
				GuideGril3.this, R.anim.tutorail_lrs);
	...
	// 按钮处理
		public void next(View view){
			// 下一步
			Intent intent = new Intent(GuideGril3.this ,GuideGril4.class);
		...
		public void prevent(View view){
			// 上一步
			Intent intent = new Intent(GuideGril3.this ,GuideGril2.class);
			intent.putExtra("info", info);
			startActivity(intent);
			MyApplication.getInstance().removeActivity(this);
			finish();
