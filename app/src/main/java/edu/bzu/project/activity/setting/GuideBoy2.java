...
public class GuideBoy2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Animation animation0 = AnimationUtils.loadAnimation(
				GuideBoy2.this, R.anim.tutorail_bottom);
		...
		Animation animation2 = AnimationUtils.loadAnimation(
				GuideBoy2.this, R.anim.tutorail_lr);
		...
		Animation animation3 = AnimationUtils.loadAnimation(
				GuideBoy2.this, R.anim.tutorail_lrs);
	...
	public void next(View view){	
		// 下一步
		Intent intent = new Intent(GuideBoy2.this ,GuideBoy3.class);
	...
	public void prevent(View view){
		// 上一步
		Intent intent = new Intent(GuideBoy2.this ,Guide.class);
		intent.putExtra("info", info);
		startActivity(intent);
		MyApplication.getInstance().removeActivity(this);
		finish();	
