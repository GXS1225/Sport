...
public class GuideBoy4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Animation animation0 = AnimationUtils.loadAnimation(
				GuideBoy4.this, R.anim.tutorail_bottom);
		...
		Animation animation1 = AnimationUtils.loadAnimation(
				GuideBoy4.this, R.anim.push_left_in);
		...
		Animation animation2 = AnimationUtils.loadAnimation(
				GuideBoy4.this, R.anim.tutorail_lr);
		...
		Animation animation3 = AnimationUtils.loadAnimation(
				GuideBoy4.this, R.anim.tutorail_lrs);
	...
	// 按钮处理
		public void next(View view){
		    ...
		    Intent intent = new Intent(GuideBoy4.this ,SetAim.class);
		    info.setAge(age);
		...
		public void prevent(View view){
			// 上一步
			Intent intent = new Intent(GuideBoy4.this ,GuideBoy3.class);
			intent.putExtra("info", info);
			startActivity(intent);
			MyApplication.getInstance().removeActivity(this);
			finish();
